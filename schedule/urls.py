...
urlpatterns = [
    ...
    path('index/signup/', view_crud.cadastrar),
    path('index/registrar', view_crud.registrar),
    path('evento/<int:id>', view_crud.visualizar),
    path('delete/evento/<int:id>/', view_crud.deletar),
    path('evento/adicionar/', view_home.adicionar),
    path('evento/editar/', view_crud.editar),
    path('salve', view_crud.salvar_ediar),
